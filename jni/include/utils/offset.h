...
namespace Offset
{
    ...
    uintptr_t bis_weapon_firing = 0x1688; // bool bIsWeaponFiring;
    ...
    //-- Class: STExtraWeapon
    uintptr_t weapon_entity_comp = 0x840; // WeaponEntity* WeaponEntityComp;
    //-- Class: WeaponEntity
    uintptr_t weapon_id = 0x178; // int WeaponId;
    //-- Class: STExtraVehicleBase
    uintptr_t vehicle_common = 0xaf8; // VehicleCommonComponent* VehicleCommon;
